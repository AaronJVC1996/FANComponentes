...
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("MSI GeForce RTX 4070 Ti SUPER", 0, 899,"La serie GAMING SLIM es una variante más delgada de la serie GAMING que mantiene capacidades de alto rendimiento y una apariencia agresiva.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Zotac Gaming GeForce GTX", 0, 139.99,"La nueva generación de tarjetas gráficas ZOTAC GAMING GeForce GTX está aquí. Basado en la nueva arquitectura NVIDIA Turing, está equipado con memoria ultrarrápida GDDR6. Prepárate para ser rápido y fuerte.");


INSERT INTO COMPONENTES  (nombre, stock, precio, descripcion) VALUES ("Thrustmaster T16000M FCS", 0, 64.99,"El T.16000M FCS Flight Pack se ha diseñado para los pilotos avanzados que buscan controles realistas y completos como alternativa a usar un ratón y un teclado.
...
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Thrustmaster TCA Yoke Pack Boeing", 0, 497.18,"TCA YokePack Boeing Edition es un sistema de aviación con licencia oficial de Boeing y Xbox, para Xbox Oney Xbox Series X|S. También es compatible con PC.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Thrustmaster SimTask FarmStick Joystick", 0, 89.98,"El SimTask FarmStick es el joystick diseñado para controlar maquinaria agrícola y pesada, desarrollado según los conocimientos de Thrustmaster en simulación de vuelo. Con sus 3 ejes direccionales, 2 con sensores magnéticos H.E.A.R.T (HallEffect AccuRate Technology), puedes controlar con precisión carretillas elevadoras, grúas y todos los demás tipos de maquinaria agrícola y de construcción.
...
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("GIGABYTE B550M AORUS ELITE mATX", 0, 103.00,"La placa base Gigabyte B550M AORUS ELITE soporta los procesadores AMD Ryzen de tercera generación.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("MSI B650 GAMING PLUS WIFI", 0, 160.90,"B650 GAMING PLUS WIFI está diseñado con toneladas de conectividad, herramientas flexibles y una conveniente solución Wi-Fi con versión de memoria DDR5 para jugadores que quieren todo");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("MSI MAG B650 TOMAHAWK WIFI", 0, 232.99,"La serie MAG lucha junto a los jugadores en busca del honor. Con elementos de inspiración militar agregados en estos productos de juego, renacieron como el símbolo de robustez y durabilidad.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("MSI B450M-A PRO MAX", 0, 62.99, "Placa base AMD AM4 inspirada en el diseño arquitectónico, con Core Boost, DDR4 Boost, Turbo M.2, USB 3.2 Gen1");

INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Nox Hummer GD750 750W 80 Plus Gold", 0, 91.98,"Hummer GD, son las fuentes con certificado 80 PLUS Gold de Nox. Se trata de fuentes que garantizan una eficiencia del 90%, diseñadas para aquellos que necesitan una potencia estable y una garantía de rendimiento en equipos de altas prestaciones.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Mars Gaming MPIII750 Fuente Alimentación PC 750W ATX", 0, 46.98, "FUENTE DE ALIMENTACIÓN MPIII750. 5 años de garantía gracias a la última tecnología de fabricación SMD de alta precisión, PCB de doble capa de fibra de vidrio y componentes grado-A de fiabilidad total. Silencio máximo con la nueva tecnología AI-RPM. 99% eficiencia DIGITAL APFC, 85% de eficiencia eléctrica, cables planos negros extra-largos y todos los sistemas de protección y seguridad incluidos.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Corsair CV Series CV650 650W 80 Plus Bronze V2", 0, 69.97, "Las fuentes de alimentación CORSAIR CV son perfectas para alimentar su nuevo PC en casa o en la oficina, con la eficacia 80 PLUS Bronze garantizada para proporcionar una potencia plena continuamente al sistema.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Tempest PSU 750W", 0, 50.99,"Tempest una vez más presenta una
...
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Tempest Liquid Cooler 360 ARGB Kit de Refrigeración Líquida", 0, 134.99, "Refrigeracion liquida de la mano de Tempest Liquid con un radiador incluido y dos tubos RGB");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Forgeon Azoth 360 ARGB", 0, 139.99, "Forgeon nos presenta su modelo mejorado de refrigeración líquida. El Kit Forgeon Azoth 360 ARGB de color Negro. Un modelo superior que incorpora 3 ventiladores, con iluminación RGB donde tienes la posibilidad de elegir entre sus múltiples efectos. También incorpora una bomba con efecto infinito ajustable en 12 posiciones donde contarás con un rendimiento térmico de hasta 360 W. Sin duda una auténtica bestia de la refrigeración.");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("Tempest Liquid Cooler 120 Kit", 0, 50.99, "Tempest Liquid Cooler 120 Kit Liquid Cooler Negra es la solución perfecta para mantener tu sistema gaming fresco y potente sin la distracción de la iluminación RGB. Este refrigerador líquido de alto rendimiento ha sido diseñado para enfriar eficientemente tu procesador, garantizando temperaturas bajas y una vida útil prolongada para tu equipo");
INSERT INTO COMPONENTES (nombre, stock, precio, descripcion) VALUES ("MSI MAG CoreLiquid 360R V2 Kit ", 0, 109.99, "La nueva refrigeración líquida MAG CORELIQUID Series tiene todo lo que buscas, materiales de alta calidad que facilitan la disipación del calor de forma extremadamente efectiva. Cómo no, cuenta con iluminación ARGB y un bloque capaz de rotar hasta 270 grados. El diseño del bloque es único y asimétrico. Cada componente individual de MAG CORELIQUID Series ha sido diseñado con un único fin: Conseguir la mejor disipación.");
