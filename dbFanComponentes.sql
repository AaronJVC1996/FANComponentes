...
INSERT INTO COMPONENTES VALUES ("CPU0001", "i7-7700k", 2, 319.77,"Con la tecnología Intel Turbo Boost 2.0, su ordenador ofrecerá una potencia y una gran capacidad de respuesta que le ayudarán a aumentar su productividad.");
...
INSERT INTO COMPONENTES VALUES ("RAM0001", "Corsair Vengeance RGB Pro DDR4 3200", 2, 87.99,"La memoria con overclocking DDR4 Corsair Vengeance RGB Pro ilumina el PC con un efecto hipnótico gracias a la iluminación RGB dinámica multizona, además de ofrecer las mejores características de las DDR4 en cuanto a rendimiento.");
...
INSERT INTO COMPONENTES VALUES ("GPU0002", "MSI GeForce RTX 3060 VENTUS 2X OC", 2, 279.99,"VENTUS ofrece un diseño centrado en el rendimiento que mantiene los elementos esenciales para realizar cualquier tarea. Una disposición de doble ventilador en un diseño industrial rígido permite que esta tarjeta gráfica de aspecto elegante se adapte a cualquier construcción.
...
INSERT INTO COMPONENTES VALUES ("MOT0001", "GIGABYTE B550M AORUS ELITE mATX", 3, 103.00,"La placa base Gigabyte B550M AORUS ELITE soporta los procesadores AMD Ryzen de tercera generación.");
...
INSERT INTO COMPONENTES VALUES ("ALI0004", "Tempest PSU 750W", 1, 50.99,"Tempest una vez más presenta una
...
-- Cambio de Clientes a proveedores --

-- Actualizar los IDs de "Cliente" a "Proveedor" en la tabla ROLES
begin;


UPDATE ROLES
SET IDROL = CONCAT('P', SUBSTRING(IDROL, 2))
WHERE IDROL LIKE 'C%';
